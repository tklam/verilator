...
private:
    ...
    bool m_xmlWriteNotFoundModuleInstancePorts = false; // main switch: --xml-write-not-found-module-instance-ports
...
public:
    ...
    bool xmlWriteNotFoundModuleInstancePorts() const { return m_xmlWriteNotFoundModuleInstancePorts; }
